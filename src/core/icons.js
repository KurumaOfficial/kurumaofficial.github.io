...
const ICON_MARKUP = Object.freeze({
    ...
    share: '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.06-.22.09-.45.09-.7s-.03-.48-.09-.7l7.05-4.11A2.99 2.99 0 0 0 18 7.91 3 3 0 1 0 15 5c0 .25.03.49.09.72L8.04 9.83A2.99 2.99 0 0 0 6 9a3 3 0 1 0 2.04 5.19l7.12 4.16c-.05.2-.08.41-.08.63a2.92 2.92 0 1 0 2.92-2.9Z" fill="currentColor"/></svg>',
