...
const ICON_MARKUP = Object.freeze({
    ...
    workspace_premium: '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M5.2 18.2h13.6l-1.45-7.45-4.2 3.1L12 8.1l-1.15 5.75-4.2-3.1Z" fill="currentColor"/><path d="M5 20h14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',
