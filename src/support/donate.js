...
const COPY = Object.freeze({
    ru: {
        common: {
            ...
            topDesc: 'Чем больше сумма, тем ярче тёплое свечение карточки.',
    ...
    en: {
        common: {
            ...
            topDesc: 'The higher the amount, the brighter the warm glow of the card.',
    ...
    ua: {
        common: {
            ...
            topDesc: 'Що більша сума, то сильніше тепле сяйво картки.',
