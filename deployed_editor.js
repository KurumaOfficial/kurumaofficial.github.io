...
const ADMIN_MESSAGES = Object.freeze({
    ru: {
        ...
        toastSavedLocalWithFiles: 'Применено и сохранено локально. Файлы не опубликованы и останутся в очереди только до перезагрузки страницы; для общего релиза нажмите «Сохранить глобально» в этой сессии.',
        toastSavedLocal: 'Применено и сохранено локально. Изменения уже видны в этом браузере и в preview-вкладках с Главной.',
        ...
        navMiscLabel: 'Прочее',
        sidebarBrandSub: 'Admin Route',
        headerLabel: 'Admin route',
        chipDirty: 'Нужен apply',
        chipSaved: 'Сохранено локально',
        productsTotal: 'Всего:',
        productsShowcase: 'Витрина:',
        productsSearchPlaceholder: 'Поиск…',
        productsAddAria: 'Добавить продукт',
        editorEmptyTitle: 'Выбери продукт слева, чтобы открыть редактор.',
        editorTitle: 'Редактирование',
        editorSubtitle: 'Поля ниже меняют черновик и обновляют карточку продукта в каталоге.',
        editorCloseAria: 'Закрыть редактор продукта',
        tabMain: 'Основное',
        tabContent: 'Контент',
        tabMedia: 'Медиа',
        ...
        fieldOrder: 'Порядок',
        fieldStage: 'Стадия',
        fieldStageNone: 'Без флага',
        fieldTone: 'Цвет карточки',
        fieldToneRed: 'Красный',
        fieldToneGreen: 'Зелёный',
        fieldStatus: 'Статус',
        fieldDesc: 'Краткое описание',
        fieldInstructions: 'Инструкция (каждый пункт с новой строки)',
        fieldNote: 'Примечание',
        fieldShowcase: 'Витрина',
        fieldShowcaseToggle: 'Показывать на витрине',
        fieldShowcaseOrder: 'Порядок на витрине',
        fieldDownload: 'Download URL',
        fieldDownloadName: 'Имя файла при скачивании',
        fieldSource: 'Исходный код',
        fieldDownloadFile: 'Файл для публикации',
        fieldDownloadFileMeta: 'Файл не выбран.',
        fieldDownloadFileClear: 'Убрать файл',
        fieldAutoRedirect: 'Авто-redirect на этот route',
        fieldAutoRedirectHelp: 'Если включено, сайт сразу открывает этот продуктовый route.',
        mediaGalleryTitle: 'Галерея изображений',
        mediaGalleryHelp: 'Загружайте скриншоты и изображения продукта. Файлы автоматически конвертируются в WebP.',
        mediaImageUpload: 'Добавить изображение',
        mediaImageHelp: 'JPG, PNG или WebP до 100MB',
        mediaNoImages: 'Изображения не загружены. Загрузите первое изображение выше.',
        mediaVideoTitle: 'Видео',
        mediaVideoHelp: 'Загружайте видео-трейлеры и демонстрации продукта.',
        mediaVideoUpload: 'Добавить видео',
        mediaVideoFileHelp: 'MP4 или WebM до 100MB',
        mediaNoVideos: 'Видео не загружены.',
        fieldRouteModulesTitle: 'Модули',
        fieldRouteCategory: 'Категория',
        fieldRouteCategoryPlayer: 'На игроке',
        fieldRouteCategoryWorld: 'В мире',
        fieldRouteCategoryUtils: 'Утилиты',
        fieldRouteCategoryOther: 'Остальное',
        fieldRouteCategoryInterface: 'Интерфейс',
        fieldRouteCategoryThemes: 'Темы',
        fieldRouteAddBtn: 'Функция',
        editorDeleteBtn: 'Удалить',
        homeMetricProducts: 'Продукты',
        homeMetricFeatured: 'Витрина',
        homeMetricTeam: 'Команда',
        homeMetricSocial: 'Соц. ссылки',
        homeMetricUploads: 'Очередь загрузок',
        supportMetricMin: 'Мин. донат',
        supportMetricRole: 'Роль Discord',
        supportMetricMethods: 'Методов оплаты',
        supportMetricSupporters: 'Поддержавших',
        supportSettingsTitle: 'Базовые настройки',
        supportSettingsSub: 'Параметры публичной donate-страницы',
        supportMinAmountLabel: 'Минимальная сумма (USD)',
        supportRoleLabel: 'Название роли',
        supportButtonsColumn: 'Способы поддержки',
        supportSupportersColumn: 'Поддержавшие',
        supportAddMethod: 'Добавить',
        supportAddSupporter: 'Участник',
        miscSocialsTitle: 'Социальные ссылки',
        miscSocialsSub: 'Показываются в футере и под витриной продуктов',
        miscSocialsPreview: 'Превью кнопок',
        miscTeamEditorTitle: 'Редактор участника',
        miscTeamEditorSub: 'Заполняет публичную карточку команды на сайте',
        miscTeamEmpty: 'Выбери участника слева или создай новую карточку кнопкой «Участник».',
        miscTeamCloseAria: 'Закрыть редактор участника',
        miscTeamMember: 'Участник',
        miscTeamSubtitle: 'Поля ниже сразу редактируют командный блок в черновике.',
        miscTeamFieldName: 'Имя',
        miscTeamFieldRole: 'Роль',
        miscTeamFieldAvatar: 'Ссылка на аватар',
        miscTeamFieldOrder: 'Порядок',
        miscTeamFieldBio: 'Описание',
        miscTeamFooterNote: 'Карточка обновляет общий черновик витрины и команды.',
        miscTeamListTitle: 'Команда',
        miscTeamListSub: 'Карточки участников, порядок и краткие описания',
        miscTeamCardsCount: 'Карточек:',
    ...
    en: {
        ...
        toastSavedLocalWithFiles: 'Applied and saved locally. Files were not published and stay queued only until this page is reloaded; use Save Globally in this session to publish them for everyone.',
        toastSavedLocal: 'Applied and saved locally. Changes are now visible in this browser and in preview tabs opened from Home.',
        ...
        sidebarBrandSub: 'Admin Route',
        headerLabel: 'Admin route',
        chipDirty: 'Apply required',
        chipSaved: 'Saved locally',
        productsTotal: 'Total:',
        productsShowcase: 'Showcase:',
        productsSearchPlaceholder: 'Search…',
        productsAddAria: 'Add product',
        editorEmptyTitle: 'Pick a product on the left to open the editor.',
        editorTitle: 'Editing',
        editorSubtitle: 'Fields below mutate the draft and update the product card in the catalog.',
        editorCloseAria: 'Close product editor',
        tabMain: 'Main',
        tabContent: 'Content',
        tabMedia: 'Media',
        tabPublish: 'Publish',
        ...
        fieldOrder: 'Order',
        fieldStage: 'Stage',
        fieldStageNone: 'No flag',
        fieldTone: 'Card colour',
        fieldToneRed: 'Red',
        fieldToneGreen: 'Green',
        fieldStatus: 'Status',
        fieldDesc: 'Short description',
        fieldInstructions: 'Instructions (one per line)',
        fieldNote: 'Note',
        fieldShowcase: 'Showcase',
        fieldShowcaseToggle: 'Show on the showcase',
        fieldShowcaseOrder: 'Showcase order',
        fieldDownload: 'Download URL',
        fieldDownloadName: 'Download file name',
        fieldSource: 'Source code',
        fieldDownloadFile: 'File for publication',
        fieldDownloadFileMeta: 'No file selected.',
        fieldDownloadFileClear: 'Clear file',
        fieldAutoRedirect: 'Auto-redirect to this route',
        fieldAutoRedirectHelp: 'When enabled, the site immediately opens this product route.',
        mediaGalleryTitle: 'Image Gallery',
        mediaGalleryHelp: 'Upload screenshots and product images. Files are automatically converted to WebP.',
        mediaImageUpload: 'Add image',
        mediaImageHelp: 'JPG, PNG or WebP up to 100MB',
        mediaNoImages: 'No images uploaded. Upload your first image above.',
        mediaVideoTitle: 'Videos',
        mediaVideoHelp: 'Upload video trailers and product demonstrations.',
        mediaVideoUpload: 'Add video',
        mediaVideoFileHelp: 'MP4 or WebM up to 100MB',
        mediaNoVideos: 'No videos uploaded.',
        fieldRouteModulesTitle: 'Modules',
        fieldRouteCategory: 'Category',
        fieldRouteCategoryPlayer: 'Player',
        fieldRouteCategoryWorld: 'World',
        fieldRouteCategoryUtils: 'Utilities',
        fieldRouteCategoryOther: 'Other',
        fieldRouteCategoryInterface: 'Interface',
        fieldRouteCategoryThemes: 'Themes',
        fieldRouteAddBtn: 'Function',
        editorDeleteBtn: 'Delete',
        homeMetricProducts: 'Products',
        homeMetricFeatured: 'Showcase',
        homeMetricTeam: 'Team',
        homeMetricSocial: 'Socials',
        homeMetricUploads: 'Upload queue',
        supportMetricMin: 'Min donate',
        supportMetricRole: 'Discord role',
        supportMetricMethods: 'Payment methods',
        supportMetricSupporters: 'Supporters',
        supportSettingsTitle: 'Base settings',
        supportSettingsSub: 'Public donate page parameters',
        supportMinAmountLabel: 'Min amount (USD)',
        supportRoleLabel: 'Role name',
        supportButtonsColumn: 'Support methods',
        supportSupportersColumn: 'Supporters',
        supportAddMethod: 'Add',
        supportAddSupporter: 'Member',
        miscSocialsTitle: 'Social links',
        miscSocialsSub: 'Shown in the footer and below the product showcase',
        miscSocialsPreview: 'Button preview',
        miscTeamEditorTitle: 'Member editor',
        miscTeamEditorSub: 'Fills the public team card on the site',
        miscTeamEmpty: 'Pick a member on the left or create a new card with the “Member” button.',
        miscTeamCloseAria: 'Close member editor',
        miscTeamMember: 'Member',
        miscTeamSubtitle: 'Fields below directly edit the team block in the draft.',
        miscTeamFieldName: 'Name',
        miscTeamFieldRole: 'Role',
        miscTeamFieldAvatar: 'Avatar URL',
        miscTeamFieldOrder: 'Order',
        miscTeamFieldBio: 'Bio',
        miscTeamFooterNote: 'Card updates the showcase and team draft together.',
        miscTeamListTitle: 'Team',
        miscTeamListSub: 'Member cards, order and short bios',
        miscTeamCardsCount: 'Cards:',
    ...
    ua: {
        ...
        toastSavedLocalWithFiles: 'Застосовано та збережено локально. Файли не опубліковані й залишаться в черзі лише до перезавантаження сторінки; для спільного релізу натисніть «Зберегти глобально» в цій сесії.',
        toastSavedLocal: 'Застосовано та збережено локально. Зміни вже видно в цьому браузері та у preview-вкладках з Головної.',
        ...
        sidebarBrandSub: 'Admin Route',
        headerLabel: 'Admin route',
        chipDirty: 'Потрібно застосувати',
        chipSaved: 'Збережено локально',
        productsTotal: 'Усього:',
        productsShowcase: 'Вітрина:',
        productsSearchPlaceholder: 'Пошук…',
        productsAddAria: 'Додати продукт',
        editorEmptyTitle: 'Вибери продукт ліворуч, щоб відкрити редактор.',
        editorTitle: 'Редагування',
        editorSubtitle: 'Поля нижче змінюють чернетку та оновлюють картку продукту в каталозі.',
        editorCloseAria: 'Закрити редактор продукту',
        tabMain: 'Основне',
        tabContent: 'Контент',
        tabMedia: 'Медіа',
        tabPublish: 'Публікація',
        tabRoute: 'Route',
        fieldName: 'Назва',
        fieldSlug: 'ID / якір',
        fieldTag: 'Тег',
        ...
        fieldOrder: 'Порядок',
        fieldStage: 'Стадія',
        fieldStageNone: 'Без прапора',
        fieldTone: 'Колір картки',
        fieldToneRed: 'Червоний',
        fieldToneGreen: 'Зелений',
        fieldStatus: 'Статус',
        fieldDesc: 'Короткий опис',
        fieldInstructions: 'Інструкція (кожен пункт з нового рядка)',
        fieldNote: 'Примітка',
        fieldShowcase: 'Вітрина',
        fieldShowcaseToggle: 'Показувати на вітрині',
        fieldShowcaseOrder: 'Порядок на вітрині',
        fieldDownload: 'Download URL',
        fieldDownloadName: 'Імʼя файлу для скачування',
        fieldSource: 'Сирці',
        fieldDownloadFile: 'Файл для публікації',
        fieldDownloadFileMeta: 'Файл не вибрано.',
        fieldDownloadFileClear: 'Прибрати файл',
        fieldAutoRedirect: 'Авто-redirect на цей route',
        fieldAutoRedirectHelp: 'Якщо увімкнено, сайт одразу відкриває цей продуктовий route.',
        mediaGalleryTitle: 'Галерея зображень',
        mediaGalleryHelp: 'Завантажуйте скріншоти та зображення продукту. Файли автоматично конвертуються в WebP.',
        mediaImageUpload: 'Додати зображення',
        mediaImageHelp: 'JPG, PNG або WebP до 100MB',
        mediaNoImages: 'Зображення не завантажені. Завантажте перше зображення вище.',
        mediaVideoTitle: 'Відео',
        mediaVideoHelp: 'Завантажуйте відео-трейлери та демонстрації продукту.',
        mediaVideoUpload: 'Додати відео',
        mediaVideoFileHelp: 'MP4 або WebM до 100MB',
        mediaNoVideos: 'Відео не завантажені.',
        fieldRouteModulesTitle: 'Модулі',
        fieldRouteCategory: 'Категорія',
        fieldRouteCategoryPlayer: 'На гравці',
        fieldRouteCategoryWorld: 'У світі',
        fieldRouteCategoryUtils: 'Утиліти',
        fieldRouteCategoryOther: 'Інше',
        fieldRouteCategoryInterface: 'Інтерфейс',
        fieldRouteCategoryThemes: 'Теми',
        fieldRouteAddBtn: 'Функція',
        editorDeleteBtn: 'Видалити',
        homeMetricProducts: 'Продукти',
        homeMetricFeatured: 'Вітрина',
        homeMetricTeam: 'Команда',
        homeMetricSocial: 'Соц. посилання',
        homeMetricUploads: 'Черга завантажень',
        supportMetricMin: 'Мін. донат',
        supportMetricRole: 'Роль Discord',
        supportMetricMethods: 'Способів оплати',
        supportMetricSupporters: 'Підтримувачів',
        supportSettingsTitle: 'Базові налаштування',
        supportSettingsSub: 'Параметри публічної donate-сторінки',
        supportMinAmountLabel: 'Мінімальна сума (USD)',
        supportRoleLabel: 'Назва ролі',
        supportButtonsColumn: 'Способи підтримки',
        supportSupportersColumn: 'Підтримувачі',
        supportAddMethod: 'Додати',
        supportAddSupporter: 'Учасник',
        miscSocialsTitle: 'Соціальні посилання',
        miscSocialsSub: 'Показуються у футері та під вітриною продуктів',
        miscSocialsPreview: 'Превʼю кнопок',
        miscTeamEditorTitle: 'Редактор учасника',
        miscTeamEditorSub: 'Заповнює публічну картку команди на сайті',
        miscTeamEmpty: 'Вибери учасника ліворуч або створи нову картку кнопкою «Учасник».',
        miscTeamCloseAria: 'Закрити редактор учасника',
        miscTeamMember: 'Учасник',
        miscTeamSubtitle: 'Поля нижче одразу редагують командний блок у чернетці.',
        miscTeamFieldName: 'Імʼя',
        miscTeamFieldRole: 'Роль',
        miscTeamFieldAvatar: 'Посилання на аватар',
        miscTeamFieldOrder: 'Порядок',
        miscTeamFieldBio: 'Опис',
        miscTeamFooterNote: 'Картка оновлює загальну чернетку вітрини та команди.',
        miscTeamListTitle: 'Команда',
        miscTeamListSub: 'Картки учасників, порядок і короткі описи',
        miscTeamCardsCount: 'Карток:',
...
export function createEditorController({ renderSite, showToast, locale = 'ru' }) {
    ...
    (function applyAdminStaticCopy() {
        ...
        /* ── Generic data-admin-i18n traversal ─────────────── */
        ...
        document.querySelectorAll('[data-admin-i18n-aria]').forEach((el) => {
            const key = el.getAttribute('data-admin-i18n-aria');
            if (!key) return;
            const value = msg(key);
            if (!value) return;
    ...
    function setEditorTab(tab) {
        editorActiveTab = ['tab-main', 'tab-content', 'tab-media', 'tab-publish', 'tab-route'].includes(tab) ? tab : 'tab-main';
        syncEditorTabs();
    }
